...
the epidemic. Here, I present two such models, Exponential Growth, and Suceptible-Infectious-Recovered (SIR) model.
...
* For Exponential Growth models, it is necessary to know the growth rate and the initial suceptible population
...
This application only has two types of model incorporated. In the future I expect to add other types of models such as:
